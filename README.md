...
Для формирования таблицы необходимо проанализировать активы (акции, облигации) брокерского портфеля Тинькофф. В портфеле формируется таблица по секторам экономики и активам. Если актив в портфеле занимает менее 2,5% - таблица выделяется жёлтым цветом, что обозначает необходимость усреднить данный актив.
